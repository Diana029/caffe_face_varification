...
def compare():
  ...
  caffe.set_mode_cpu()
  #load the model
  net = caffe.Net('/home/diana/Desktop/vgg_face_caffe/VGG_FACE_deploy.prototxt',
                '/home/diana/Desktop/vgg_face_caffe/VGG_FACE.caffemodel',
                caffe.TEST)
